$(document).ready(function () 
{
    ...
    const API_ENDPOINT_DEPOSITO = '/api/pay/save.php';
    const API_ENDPOINT_RETIRADA = '/api/pay/save.php';
    const API_ENDPOINT_CASSINO = '/api/pay/save.php';
    ...
    $loadModalButtons.on('click', function (event) {
        ...
        const modalUrl = "/data/modals/"+$button.data('modal-url'); 
